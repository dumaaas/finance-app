  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (code === "permission-denied") {
        toast.error(
          "Nemate dozvolu za cuvanje kategorija. Provjerite Firestore pravila.",
        );
      } else {
    ...
    >
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description="Dodaj kategorije ili ucitaj podrazumjevane"
        />
      ) : (
            ...
            <Card key={cat.id} className="p-0! overflow-hidden">
              <div className="flex items-center gap-3 p-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs opacity-50">
                    {cat.subcategories.length} podkategorija
                  </p>
                </div>
              ...
              {expandedId === cat.id && cat.subcategories.length > 0 && (
                <div
                  className={cn(
                    "px-4 pb-3 border-t",
                    theme === "dark" ? "border-dark-800" : "border-dark-100",
                  )}
                >
      ...
      <Modal
        ...
        title={editingId ? "Uredi kategoriju" : "Nova kategorija"}
        size="lg"
      >
            ...
            {formSubs.map((sub) => (
              ...
              >
                ...
                <button
                  ...
                  className="p-1 rounded hover:bg-danger-500/20"
                >
