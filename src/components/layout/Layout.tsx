  ...
  return (
    <div className="flex h-dvh overflow-hidden">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        {/* Content */}
        <div
          className={`flex-1 overflow-y-auto scrollbar-hide ${theme === "dark" ? "bg-dark-950" : "bg-white"}`}
        >
...
function MobileNavItem({
  ...
  return (
    <NavLink
      ...
      className={({ isActive }) =>
        cn(
          "flex flex-col items-center gap-0.5 px-3 py-1.5 rounded-xl transition-all min-w-15",
